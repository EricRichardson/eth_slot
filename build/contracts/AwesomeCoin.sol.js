...
(function() {
  ...
  Contract.new = function() {
    if (this.currentProvider == null) {
      throw new Error("AwesomeCoin error: Please call setProvider() first before calling new().");
    }

    var args = Array.prototype.slice.call(arguments);

    if (!this.unlinked_binary) {
      throw new Error("AwesomeCoin error: contract binary not set. Can't deploy new instance.");
    }
    ...
    if (unlinked_libraries != null) {
      ...
      throw new Error("AwesomeCoin contains unresolved libraries. You must deploy and link the following libraries before you can deploy a new version of AwesomeCoin: " + unlinked_libraries);
    }
  ...
  Contract.at = function(address) {
    if (address == null || typeof address != "string" || address.length != 42) {
      throw new Error("Invalid address passed to AwesomeCoin.at(): " + address);
    }
  ...
  Contract.deployed = function() {
    if (!this.address) {
      throw new Error("Cannot find deployed address: AwesomeCoin not deployed or address not set.");
    }
  ...
  "default": {
    ...
    "updated_at": 1470961593142,
    "links": {},
    "address": "0x08efeec392d6ecacd72567673fd1b4e26c48c281"
  }
};
  ...
  Contract.contract_name   = Contract.prototype.contract_name   = "AwesomeCoin";
